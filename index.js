  ...
  if (code === "0") {
    ...
    if (report) {
      ...
      const lines = [
        ...
        `Total meals outside: ${report.counts.f} times, ${formatDurationLong(report.durations.f)}`,
        `Total meals: ${report.counts.mb} times, ${formatDurationLong(report.durations.mb)}`,
        "",
